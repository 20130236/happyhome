                                ...
                                <h5>Thông tin người dùng</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <div>
                                                <input class="form-control" id="password" name="password" type="password" value="<%=user.getPassWord()%>">
                                    ...
                                    <tr>
                                        <th class="first_item" style="width:9.9875pc">Nhập lại mật khẩu :</th>
                                        <td>
                                            <div class="form-group">
                                                <div>
                                                    <input class="form-control" id="password_again" name="password_again" type="password" value="<%=user.getPassWord()%>">
                                                    <label id="password-again-error" class="error" for="password_again" style="display: inline;"></label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
